...
public interface EmployeeLocalService
	...
	public Employee createEmployee(long Prson_id);
	...
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public Employee fetchEmployee(long Prson_id);
	 ...
	 */
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public Employee getEmployee(long Prson_id) throws PortalException;
